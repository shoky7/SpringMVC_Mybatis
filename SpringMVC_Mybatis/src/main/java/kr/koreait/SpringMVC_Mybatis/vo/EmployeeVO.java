...
public class EmployeeVO {
	...
	private Date convertJoin_day;
	private Date convertRetire_day;
	...
	public Date getConvertJoin_day() {
		return convertJoin_day;
	}
	public void setConvertJoin_day(Date convertJoin_day) {
		this.convertJoin_day = convertJoin_day;
	}
	public Date getConvertRetire_day() {
		return convertRetire_day;
	}
	public void setConvertRetire_day(Date convertRetire_day) {
		this.convertRetire_day = convertRetire_day;
	}
